AiGameMaker
## 課程主題：以問題為學習導向的 Ai 輔助互動頁面建置  
科技輔助製作在人工智慧的進步下有長足進步，教師透過 Ai 轉化學習內容，在教學場域中可規劃設計不同學習任務供學生學習，例如透過遊戲化設置、模擬真實情境、提供複雜參數模擬結果等不同目的來製作網頁，小如數學質因數小遊戲、語文Ai引導作文介面設計、乃至設計光學透鏡、產生協助網頁編輯工具、模擬螞蟻費洛蒙系統、…等等，過去需工程師協助的專業，如今在電腦中一行提示詞即可實現。
本研習帶領教師透過 chatgpt 設計 java 網頁，實作 github 網站部署，在與 Ai 工具互動之間捕捉知能，產出符合現場需求的教學網頁。
1. 一行程式走天下  
	- 一句話：不斷堆疊上去  
	- 結構式語法
		+ 累積所有
		+ 一次生成
		+ 發現矛盾  
2. 利用 obsidian 記錄 .md 的一切  
3. 不斷地迭代：利用工具做工具 
4. github pages 使用、入口網頁編輯與架構  
5. 知識系統建置：從什麼都不知道開始，舉螞蟻費洛蒙系統為例  
6. 使用者為導向的設計與 GA 使用  
7. 回歸本質：使用 Ai 工具的極致是搞清楚自己要什麼
...
1. 自己寫網頁於教學上意義
	...
	5. 如何評鑑課程？
1. 課綱淬鍊不容易文本呈現的內容：science class
	1. 物質與粒子
	...
	3. 電與磁
		...
		2. 磁感應|難以觀察磁場變化|「線圈與磁鐵互動」：移動磁鐵或改變圈數，看感應電流方向（含右手定則動畫）
...
1. survey
	1. [AntEmpire](https://chyijiunn.github.io/eduGame/games/ant-empire/)
		1. 構思大
			1. 從論文開始
				1. 請整理費洛蒙相關功能並列表呈現
		...
		2. 隨便給一句話
			...
			2. 注意 token 量
	1. 旅遊規劃
		1. [走路地圖](https://chyijiunn.github.io/eduGame/games/tourmap/)
		1. [語言](https://chyijiunn.github.io/eduGame/games/Czech-language/)
		1. [自主食譜](https://chyijiunn.github.io/eduGame/games/facet-search/)
1. 遊戲化要素-機制
	1. 正向條件目的
		1. 摧毀 / 建構
...
1. 遊戲化例子
	1. [遺傳法則](https://chyijiunn.github.io/eduGame/games/geneticsLaw/)遊戲
	1. 達爾文演化之[人擇](https://chyijiunn.github.io/eduGame/games/human-select/)遊戲 
	1. [Quarto](https://chyijiunn.github.io/eduGame/games/quarto-element/)
		...
		- 利用這桌遊規則製作一個化學元素符號的版本，有16種元素，這些元素需符合 quarto 棋子特性， 並利用四個特性中的每一個特性就可將16個分為兩組各八個， 盡可能讓16個元素特性排列出、每個元素都有獨一無二的特性，沒有彼此重複特性如同原本遊戲的木頭設計。
		- 分類特徵為台灣國中學生的學習內容，找出這16個元素，並且將四個特徵列表後再細分兩類也分出
	1. 設計一個消化系統互動網頁，可用瀏覽器打開的單一 HTML
		1. a 拼完後，食物通過
			1. 目標
...
---
## 網站規劃
1. 入口網頁規劃，[範例](https://chyijiunn.github.io/eduGame/games/ai-game-maker/demo.html)
...
2. 先改模板
	...
	3. 圖 [svg](https://chyijiunn.github.io/eduGame/games/drawSVG/)
		...
		2. 圖層概念
		3. 群組概念
3. 寫 [md](https://chyijiunn.github.io/eduGame/games/markdown/) 說明以及要求
4. 生成一個網頁
5. github desktop
6. GA
# Git pages
